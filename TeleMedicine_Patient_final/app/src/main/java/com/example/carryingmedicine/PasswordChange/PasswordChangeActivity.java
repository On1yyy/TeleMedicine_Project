...
import com.example.carryingmedicine.Main.InformationUpdate;
import com.example.carryingmedicine.Main.MainActivity;
import com.example.carryingmedicine.Main.PersonalHealthRequest;
...
import com.example.carryingmedicine.RecordHealth.Record_check_Request;
import com.example.carryingmedicine.Register.RegisterCondition;
...
public class PasswordChangeActivity extends AppCompatActivity {
    ...
    PasswordCondition passwordCondition=new PasswordCondition(this);
        ...
        btn_change2.setOnClickListener(new View.OnClickListener() {
            ...
            //비밀번호 형식 체크
                ...
                if( userPass2.length()>0) {
                    if (passwordCondition.user_pass_check(userPass2, userID)) {
                        ...
                        password_request = new Password_Request(userID, userPass2, responseListener);
                        RequestQueue queue = Volley.newRequestQueue(PasswordChangeActivity.this);
                ...
                {
                    Toast.makeText(getApplicationContext(), "공백입니다. 다시입력해주세요.", Toast.LENGTH_SHORT).show();
