package com.example.carryingmedicine.view;
...
public class Util {
    ...
    public static boolean isStorageUrl(String url){
        return Patterns.WEB_URL.matcher(url).matches() && url.contains("https://firebasestorage.googleapis.com/v0/b/login-project-3af79.appspot.com/o/post");
    }
